<div>
    ...
    <div class="app-hero-header d-flex align-items-start">
        ...
        <ol class="breadcrumb d-none d-lg-flex">
            ...
            <li class="breadcrumb-item">Buat Halaman</li>
        </ol>
    </div>
            ...
            <div class="col-sm-12">
                <div class="card mb-3">
                    <div class="card-header">
                        <h5 class="card-title">Buat Halaman</h5>
                    </div>
                    <div class="card-body">
                        <!-- Row starts -->
                        <div class="row gx-3">
                            <div class="col-lg-4 col-sm-4 col-12">
                                <div class="mb-5">
                                    <div class="position-relative d-flex justify-content-center">
                                        ...
                                        @elseif ($prevThumbnail)
                                        <img class="img img-thumbnail"
                                            style="width:150px; height:150px;object-fit:contain;"
                                            src="{{ asset('storage/page/' . $prevThumbnail) }}">
                                        @else
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-text">{{ env('APP_URL') }}/pages/</span>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="mb-3" wire:ignore>
                                            ...
                                            <select id="tags" class="form-control" multiple="multiple" wire:model="tags">
