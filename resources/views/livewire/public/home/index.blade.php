<div>
    ...
    <div id="home">
        ...
        <section class="cs-hero cs-style1 cs-bg" data-src="public_assets/img/hero_bg.svg">
            <div class="container">
                ...
                <div class="cs-hero_text">
                    ...
                    <div class="cs-hero_subtitle">You may start selling in a matter of minutes and easy to <br>use.
                        Appropriate for all devices.</div>
    ...
    <!-- Start Main Feature -->
    <section class="cs-bg" data-src="public_assets/img/feature_bg.svg">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 col-xl-3">
                    ...
                    <div class="cs-iconbox cs-style1">
                        <div class="cs-iconbox_icon cs-center">
                            <img src="public_assets/img/icons/icon_box_1.svg" alt="Icon">
                        </div>
                        <div class="cs-iconbox_in">
                            ...
                            <div class="cs-iconbox_subtitle">Lorem Ipsum is simply dummy text of the printing and formal
                                typesetting</div>
                        </div>
                    </div>
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="cs-iconbox cs-style1">
                        <div class="cs-iconbox_icon cs-center">
                            <img src="public_assets/img/icons/icon_box_2.svg" alt="Icon">
                        </div>
                        <div class="cs-iconbox_in">
                ...
                <div class="col-md-6 col-xl-3">
                    ...
                    <div class="cs-iconbox cs-style1">
                        <div class="cs-iconbox_icon cs-center">
                            <img src="public_assets/img/icons/icon_box_3.svg" alt="Icon">
                        </div>
                        <div class="cs-iconbox_in">
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="cs-iconbox cs-style1">
                        <div class="cs-iconbox_icon cs-center">
                            <img src="public_assets/img/icons/icon_box_4.svg" alt="Icon">
                        </div>
                        <div class="cs-iconbox_in">
                ...
                <div class="col-xl-6 wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.3s">
                    <div class="cs-left_full_width cs-space110">
                        <div class="cs-left_sided_img">
                            <img src="public_assets/img/about_img_1.png" alt="About">
                        </div>
                    </div>
                </div>
                <div class="col-xl-6">
                    ...
                    <div class="cs-list_1_wrap">
                        <ul class="cs-list cs-style1 cs-mp0">
                            <li>
                                <span class="cs-list_icon">
                                    <img src="public_assets/img/icons/tick.svg" alt="Tick">
                                </span>
                        ...
                        <div class="cs-list_img wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.5s"><img
                                src="public_assets/img/about_img_2.png" alt="About"></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid">
        <div class="cs-funfact_1_wrap cs-type1">
            <div class="cs-funfact cs-style1">
                <div class="cs-funfact_icon cs-center"><img src="public_assets/img/icons/funfact_icon_1.svg" alt="Icon"></div>
                <div class="cs-funfact_right">
                    <div class="cs-funfact_number cs-primary_font"><span data-count-to="320" class="odometer"></span>+
                    </div>
                    <h2 class="cs-funfact_title">Retail stores</h2>
                </div>
            </div>
            <div class="cs-funfact cs-style1">
                <div class="cs-funfact_icon cs-center"><img src="public_assets/img/icons/funfact_icon_2.svg" alt="Icon"></div>
                <div class="cs-funfact_right">
                    <div class="cs-funfact_number cs-primary_font"><span data-count-to="92" class="odometer"></span>k
                    </div>
                    <h2 class="cs-funfact_title">Customer</h2>
                </div>
            </div>
            <div class="cs-funfact cs-style1">
                <div class="cs-funfact_icon cs-center"><img src="public_assets/img/icons/funfact_icon_3.svg" alt="Icon"></div>
                <div class="cs-funfact_right">
                    <div class="cs-funfact_number cs-primary_font"><span data-count-to="5" class="odometer"></span>k
                    </div>
                    <h2 class="cs-funfact_title">Positive Rating</h2>
                </div>
            </div>
            <div class="cs-funfact cs-style1">
                <div class="cs-funfact_icon cs-center"><img src="public_assets/img/icons/funfact_icon_4.svg" alt="Icon"></div>
                <div class="cs-funfact_right">
                    <div class="cs-funfact_number cs-primary_font"><span data-count-to="20" class="odometer"></span>+
                    </div>
                ...
                <div class="row">
                    <div class="col-xl-4 col-md-6">
                        <div class="cs-iconbox cs-style1 cs-type1">
                            <div class="cs-iconbox_icon cs-center">
                                <img src="public_assets/img/icons/icon_box_5.svg" alt="Icon">
                            </div>
                            <div class="cs-iconbox_in">
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="cs-iconbox cs-style1 cs-type1">
                            <div class="cs-iconbox_icon cs-center">
                                <img src="public_assets/img/icons/icon_box_6.svg" alt="Icon">
                            </div>
                            <div class="cs-iconbox_in">
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="cs-iconbox cs-style1 cs-type1">
                            <div class="cs-iconbox_icon cs-center">
                                <img src="public_assets/img/icons/icon_box_7.svg" alt="Icon">
                            </div>
                            <div class="cs-iconbox_in">
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="cs-iconbox cs-style1 cs-type1">
                            <div class="cs-iconbox_icon cs-center">
                                <img src="public_assets/img/icons/icon_box_8.svg" alt="Icon">
                            </div>
                            <div class="cs-iconbox_in">
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="cs-iconbox cs-style1 cs-type1">
                            <div class="cs-iconbox_icon cs-center">
                                <img src="public_assets/img/icons/icon_box_9.svg" alt="Icon">
                            </div>
                            <div class="cs-iconbox_in">
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="cs-iconbox cs-style1 cs-type1">
                            <div class="cs-iconbox_icon cs-center">
                                <img src="public_assets/img/icons/icon_box_10.svg" alt="Icon">
                            </div>
                            <div class="cs-iconbox_in">
    ...
    <section class="cs-gradient_bg_1">
        ...
        <div class="container">
            <div class="cs-seciton_heading cs-style1 text-center">
                <div class="cs-section_subtitle wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s">Retail Stores
                </div>
                <div class="cs-height_10 cs-height_lg_10"></div>
            ...
            <div class="row align-items-center flex-column-reverse-lg">
                <div class="col-xl-6">
                    <div class="cs-left_full_width cs-space40">
                        <div class="cs-left_sided_img">
                            <img src="public_assets/img/retail-store.png" alt="Retail Stores">
                        </div>
                    </div>
                </div>
                <div class="col-xl-6">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="cs-iconbox cs-style2 text-center">
                                        <div class="cs-iconbox_icon"><img src="public_assets/img/icons/retail_icon_1.svg"
                                                alt="Icon"></div>
                                ...
                                <div class="col-md-6">
                                    <div class="cs-iconbox cs-style2 text-center">
                                        <div class="cs-iconbox_icon"><img src="public_assets/img/icons/retail_icon_2.svg"
                                                alt="Icon"></div>
                    ...
                    <div class="row wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.3s">
                        <div class="col-lg-11">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="cs-iconbox cs-style2 text-center">
                                        <div class="cs-iconbox_icon"><img src="public_assets/img/icons/retail_icon_3.svg"
                                                alt="Icon"></div>
                                ...
                                <div class="col-md-6">
                                    <div class="cs-iconbox cs-style2 text-center">
                                        <div class="cs-iconbox_icon"><img src="public_assets/img/icons/retail_icon_4.svg"
                                                alt="Icon"></div>
                    ...
                    <div class="row wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.3s">
                        <div class="col-lg-11 offset-lg-1">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="cs-iconbox cs-style2 text-center">
                                        <div class="cs-iconbox_icon"><img src="public_assets/img/icons/retail_icon_5.svg"
                                                alt="Icon"></div>
                                ...
                                <div class="col-md-6">
                                    <div class="cs-iconbox cs-style2 text-center">
                                        <div class="cs-iconbox_icon"><img src="public_assets/img/icons/retail_icon_6.svg"
                                                alt="Icon"></div>
    ...
    <!-- End Retail Stores -->
    <!-- Start Price Section -->
    <section class="cs-bg" data-src="public_assets/img/feature_bg.svg" id="pricing">
        <div class="cs-height_95 cs-height_lg_70"></div>
        <div class="container">
            <div class="cs-seciton_heading cs-style1 text-center">
                <div class="cs-section_subtitle wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.4s">Pricing Plan
                </div>
                <div class="cs-height_10 cs-height_lg_10"></div>
            ...
            <div class="row">
                    ...
                    <div class="cs-pricing_table cs-style1">
                        <div class="cs-pricing_head">
                            <div class="cs-pricing_heading">
                                <div class="cs-pricing_icon cs-center"><img src="public_assets/img/icons/pricing_icon_1.svg"
                                        alt="Icon"></div>
                ...
                <div class="col-lg-4">
                    <div class="cs-pricing_table cs-style1">
                        <div class="cs-pricing_head">
                            <div class="cs-pricing_heading">
                                <div class="cs-pricing_icon cs-center"><img src="public_assets/img/icons/pricing_icon_2.svg"
                                        alt="Icon"></div>
                ...
                <div class="col-lg-4">
                    <div class="cs-pricing_table cs-style1">
                        <div class="cs-pricing_head">
                            <div class="cs-pricing_heading">
                                <div class="cs-pricing_icon cs-center"><img src="public_assets/img/icons/pricing_icon_3.svg"
                                        alt="Icon"></div>
    ...
    <section class="cs-gradient_bg_1">
        ...
        <div class="container">
            <div class="cs-seciton_heading cs-style1 text-center">
                <div class="cs-section_subtitle wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.4s">Testimonials
                </div>
                <div class="cs-height_10 cs-height_lg_10"></div>
            ...
            <div class="cs-slider cs-style1 cs-gap-24">
                <div class="cs-slider_container" data-autoplay="0" data-loop="1" data-speed="600" data-fade-slide="0"
                    ...
                    <div class="cs-slider_wrapper">
                        <div class="cs-slide">
                            <div class="cs-testimonial cs-style1">
                                <div class="cs-testimonial_text">With Thrive’s help, we were able to increase the
                                    functionality of our website dramatically while were able to increase the.</div>
                                <div class="cs-testimonial_meta">
                                    <div class="cs-avatar">
                                        <img src="public_assets/img/avatar_1.png" alt="Avatar">
                                    ...
                                    <div class="cs-testimonial_meta_right">
                                        ...
                                        <div class="cs-review" data-review="4">
                                            <img src="public_assets/img/icons/stars.svg" alt="Star">
                        ...
                        <div class="cs-slide">
                            <div class="cs-testimonial cs-style1">
                                ...
                                <div class="cs-testimonial_meta">
                                    <div class="cs-avatar">
                                        <img src="public_assets/img/avatar_2.png" alt="Avatar">
                                        <div class="cs-quote cs-center">
                                            <svg width="19" height="15" viewBox="0 0 19 15" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                        ...
                        <div class="cs-slide">
                            <div class="cs-testimonial cs-style1">
                                ...
                                <div class="cs-testimonial_meta">
                                    <div class="cs-avatar">
                                        <img src="public_assets/img/avatar_3.png" alt="Avatar">
                                        <div class="cs-quote cs-center">
                                            <svg width="19" height="15" viewBox="0 0 19 15" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                    ...
                    <div class="cs-slider_wrapper">
                        <div class="cs-slide">
                            <div class="cs-client cs-accent_bg cs-center">
                                <img src="public_assets/img/client_1.svg" alt="Client">
                            </div>
                        </div><!-- .cs-slide -->
                        <div class="cs-slide">
                            <div class="cs-client cs-accent_bg cs-center">
                                <img src="public_assets/img/client_2.svg" alt="Client">
                            </div>
                        </div><!-- .cs-slide -->
                        <div class="cs-slide">
                            <div class="cs-client cs-accent_bg cs-center">
                                <img src="public_assets/img/client_3.svg" alt="Client">
                            </div>
                        </div><!-- .cs-slide -->
                        <div class="cs-slide">
                            <div class="cs-client cs-accent_bg cs-center">
                                <img src="public_assets/img/client_4.svg" alt="Client">
                            </div>
                        </div><!-- .cs-slide -->
                        <div class="cs-slide">
                            <div class="cs-client cs-accent_bg cs-center">
                                <img src="public_assets/img/client_5.svg" alt="Client">
                            </div>
                        </div><!-- .cs-slide -->
                        <div class="cs-slide">
                            <div class="cs-client cs-accent_bg cs-center">
                                <img src="public_assets/img/client_6.svg" alt="Client">
                            </div>
                        </div><!-- .cs-slide -->
                        <div class="cs-slide">
                            <div class="cs-client cs-accent_bg cs-center">
        ...
        <div class="container">
            <div class="row align-items-center flex-column-reverse-lg">
                <div class="col-xl-6 wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.4s">
                    <div class="cs-left_full_width cs-space110">
                        <div class="cs-left_sided_img">
                            <img src="public_assets/img/faq_img.png" alt="About">
                        </div>
                    </div>
                    <div class="cs-height_0 cs-height_lg_40"></div>
                </div>
    ...
    <!-- End Post Section -->
    <section class="cs-bg" data-src="public_assets/img/feature_bg.svg" id="news">
        <div class="cs-height_95 cs-height_lg_70"></div>
        <div class="container">
            <div class="cs-seciton_heading cs-style1 text-center">
                <div class="cs-section_subtitle wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.4s">Letest News
                </div>
                <div class="cs-height_10 cs-height_lg_10"></div>
                ...
                <div class="cs-slider_container" data-autoplay="0" data-loop="1" data-speed="600" data-fade-slide="0"
                    ...
                    <div class="cs-slider_wrapper">
                        <div class="cs-slide">
                            <div class="cs-post cs-style1">
                                <div class="cs-post_thumb cs-modal_btn" data-modal="details">
                                    <div class="cs-post_thumb_in cs-bg" data-src="public_assets/img/post_1.jpeg"></div>
                                </div>
                                <div class="cs-post_info">
                                    ...
                                    <h2 class="cs-post_title cs-modal_btn" data-modal="details">Point of sale software
                                        card usde</h2>
                        ...
                        <div class="cs-slide">
                            <div class="cs-post cs-style1">
                                <div class="cs-post_thumb cs-modal_btn" data-modal="details">
                                    <div class="cs-post_thumb_in cs-bg" data-src="public_assets/img/post_2.jpeg"></div>
                                </div>
                                <div class="cs-post_info">
                                    <ul class="cs-post_meta cs-mp0">
                                        <li>
                                    ...
                                    <h2 class="cs-post_title cs-modal_btn" data-modal="details">Best super shop point of
                                        sale setup</h2>
                                    <span class="cs-text_btn cs-modal_btn" data-modal="details">
                                        <span>Read More</span>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                        ...
                        <div class="cs-slide">
                            <div class="cs-post cs-style1">
                                <div class="cs-post_thumb cs-modal_btn" data-modal="details">
                                    <div class="cs-post_thumb_in cs-bg" data-src="public_assets/img/post_3.jpeg"></div>
                                </div>
                                <div class="cs-post_info">
                                    <ul class="cs-post_meta cs-mp0">
                                        <li>
                                    ...
                                    <h2 class="cs-post_title cs-modal_btn" data-modal="details">Computer new point of
                                        saie working good</h2>
                                    <span class="cs-text_btn cs-modal_btn" data-modal="details">
                                        <span>Read More</span>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                                            preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
                        ...
                        <div class="cs-slide">
                            <div class="cs-post cs-style1">
                                <div class="cs-post_thumb cs-modal_btn" data-modal="details">
                                    <div class="cs-post_thumb_in cs-bg" data-src="public_assets/img/post_4.jpeg"></div>
                                </div>
                                <div class="cs-post_info">
                                    <ul class="cs-post_meta cs-mp0">
                                        <li>
                                    ...
                                    <h2 class="cs-post_title cs-modal_btn" data-modal="details">Connection pos to phone
                                        payment option</h2>
                                    <span class="cs-text_btn cs-modal_btn" data-modal="details">
                                        <span>Read More</span>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                ...
                <div class="col-xl-5 col-lg-8">
                    ...
                    <div class="cs-iconbox cs-style3">
                        <div class="cs-iconbox_icon">
                            <img src="public_assets/img/icons/contact_icon_1.svg" alt="Icon">
                        </div>
                    ...
                    <div class="cs-iconbox cs-style3">
                        <div class="cs-iconbox_icon">
                            <img src="public_assets/img/icons/contact_icon_2.svg" alt="Icon">
                        </div>
                        <div class="cs-iconbox_right">
                    ...
                    <div class="cs-iconbox cs-style3">
                        <div class="cs-iconbox_icon">
                            <img src="public_assets/img/icons/contact_icon_3.svg" alt="Icon">
                        </div>
                        <div class="cs-iconbox_right">
                ...
                <div class="col-xl-6 offset-xl-1">
                    ...
                    <form class="cs-contact_form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <textarea cols="30" rows="5" class="cs-form_field"
